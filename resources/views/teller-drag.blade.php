...
<x-layouts.app :title="__('Drag Race — Teller Mode')">
  ...
  @else
  <body
    class="m-0 min-h-dvh overflow-y-auto overflow-x-hidden bg-[#050a15] font-[Inter,system-ui,-apple-system,Segoe_UI,Roboto,Helvetica,Arial] text-[13px] text-slate-100 print:bg-white"
  >
    <!-- BG MAIN IMAGE -->
    <div
      class="fixed inset-0 -z-30 bg-cover bg-center bg-[url('https://i.ibb.co/mCnFZSCv/Chat-GPT-Image-Oct-7-2025-03-54-39-PM.png')] blur-[2px] brightness-[.45] saturate-100"
    ></div>

    <!-- BG OVERLAY GRADIENTS -->
    <div
      class="fixed inset-0 -z-20 pointer-events-none bg-[linear-gradient(rgba(6,8,12,.45),_rgba(6,8,12,.45)),_radial-gradient(1200px_1200px_at_80%_-10%,_#141a2b77,_transparent_70%),_radial-gradient(800px_800px_at_-10%_110%,_#0b0f1c66,_transparent_60%)]"
    ></div>

    <div class="min-h-[100svh] flex justify-center px-3 py-4 sm:px-4 sm:py-6">
      <div
        class="w-full max-w-[1320px] lg:h-[780px] rounded-[18px] shadow-[0_20px_60px_rgba(0,0,0,.45)]
               bg-transparent origin-top transform
               scale-100 sm:scale-[.90] md:scale-[.94] lg:scale-[.98] xl:scale-100"
      >
        <main
          class="h-full w-full p-3 sm:p-4 grid gap-3 sm:gap-4
                 grid-cols-1 lg:grid-cols-[300px_minmax(0,1fr)_320px]"
        >

          <!-- LEFT -->
          <aside
            class="space-y-4 rounded-[16px] border border-white/10 bg-[#0c1326e6] p-3 sm:p-4 backdrop-blur-md shadow-[0_10px_30px_rgba(0,0,0,.25),inset_1px_1px_0_rgba(255,255,255,.06)]"
          >
            ...
            <div class="space-y-2">
              <button
                id="toggleVideo"
                class="inline-flex h-9 items-center gap-2 rounded-[10px] border border-white/15 bg-[#0d172f] px-3 text-[12px] sm:text-[13px]"
              >
                <span class="size-3.5 rounded-full bg-white/60"></span> Hide Video
              </button>
              <div
                class="relative aspect-[16/9] overflow-hidden rounded-[14px] border border-white/15 bg-black"
              >
                <iframe
                  id="yt"
                  class="absolute inset-0 size-full hidden border-0"
                  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                  allowfullscreen
                ></iframe>
                <div id="videoOverlay" class="absolute inset-0 grid place-items-center text-xs">
                  Video hidden
                </div>
              </div>
            </div>
            ...
            <div class="space-y-2 rounded-[12px] border border-white/12 bg-[#0d1529] p-3">
              ...
              <input
                ...
                class="h-10 w-full rounded-[10px] border border-white/15 bg-[#0a1326] px-3 outline-none text-[12px] sm:text-[13px]"
              >
              <div class="grid grid-cols-2 gap-2">
                <button
                  id="cardReset"
                  class="h-9 rounded-[10px] border border-white/15 bg-[#0c1630] text-[12px] sm:text-[13px]"
                >
                  Reset
                </button>
                <button
                  id="cardSubmit"
                  class="h-9 rounded-[10px] border border-[#1f2b50] bg-[linear-gradient(180deg,#1a4a9e,#0d2b66)] text-white text-[12px] sm:text-[13px]"
                >
                  Submit Card
                </button>
              </div>
            ...
            <div class="space-y-2 rounded-[12px] border border-white/12 bg-[#0d1529] p-3">
              ...
              <div class="grid gap-2">
                <input
                  ...
                  class="h-10 rounded-[10px] border border-white/15 bg-[#0a1326] px-3 outline-none text-[12px] sm:text-[13px]"
                >
                <input
                  id="userName"
              ...
              <div class="grid grid-cols-2 gap-2 pt-1">
                <button
                  id="scoreRed"
                  class="h-9 rounded-[10px] border border-[#3a1a1f] bg-[linear-gradient(180deg,#9a1616,#4b0a0a)] text-[#ffecec] text-[12px] sm:text-[13px]"
                >
                  Red Score
                </button>
                <button
                  id="scoreBlue"
                  class="h-9 rounded-[10px] border border-[#1f2b50] bg-[linear-gradient(180deg,#1a4a9e,#0d2b66)] text-[#e6f0ff] text-[12px] sm:text-[13px]"
                >
                  Blue Score
                </button>
                <button
          ...
          >
            ...
            <div class="space-y-2 rounded-[12px] border border-white/12 bg-[#0e1730] p-3">
              ...
              <div class="h-3 overflow-hidden rounded-full border border-white/15 bg-[#0b1224]">
                <div
                  id="barRed"
                  class="h-full w-[50%] bg-gradient-to-r from-[#ff3b30] to-[#c12018]"
                ></div>
              </div>
              <div class="flex justify-between text-[11px] opacity-75 gap-2">
                <div>Red <span id="pctRed">50%</span></div>
                <div class="truncate">Total: ₱<span id="totalPot">0</span></div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              <!-- RED CARD -->
              <div
                class="rounded-[18px] border border-white/10 bg-[linear-gradient(180deg,#f04e41_0%,_#a02121_100%)] p-4 text-white shadow-[0_10px_30px_rgba(0,0,0,.35),inset_1px_1px_0_rgba(255,255,255,.10),inset_-3px_-3px_0_rgba(0,0,0,.46)] flex flex-col items-center text-center"
              >
                <div class="flex items-center gap-2">
                  <div
                    class="grid size-9 shrink-0 place-items-center rounded-full border-2 border-white/35 bg-black/20 font-black"
                  >
                    R
                  </div>
                </div>
                <div
                  id="amtRed"
                  class="mt-1 text-[34px] sm:text-[44px] leading-[1.05] font-black tracking-[.5px]"
                >
                  0
                </div>
                <div
                  class="mt-2 grid place-items-center rounded-[12px] border border-white/30 bg-black/20 px-3 py-1.5 text-[11px] sm:text-[12px] font-black"
                >
                  PAYOUT = <span id="oddsRed" class="ml-1">1.55</span>
                </div>
                <button
                  id="betRed"
                  class="mt-3 h-10 px-4 rounded-[10px] border border-[#3a1a1f] bg-[linear-gradient(180deg,#9a1616,#4b0a0a)] text-[#ffecec] font-semibold text-[12px] sm:text-[13px] w-full sm:w-auto"
                >
                  Bet Red
                </button>
              </div>
              ...
              <!-- BLUE CARD -->
              <div
                class="rounded-[18px] border border-white/10 bg-[linear-gradient(180deg,#4f89ff_0%,_#153b90_100%)] p-4 text-white shadow-[0_10px_30px_rgba(0,0,0,.35),inset_1px_1px_0_rgba(255,255,255,.10),inset_-3px_-3px_0_rgba(0,0,0,.46)] flex flex-col items-center text-center"
              >
                <div class="flex items-center gap-2">
                  <div
                    class="grid size-9 shrink-0 place-items-center rounded-full border-2 border-white/35 bg-black/20 font-black"
                ...
                <button
                  id="betBlue"
                  class="mt-3 h-10 px-4 rounded-[10px] border border-[#1f2b50] bg-[linear-gradient(180deg,#1a4a9e,#0d2b66)] text-[#e6f0ff] font-semibold text-[12px] sm:text-[13px] w-full sm:w-auto"
                >
                  Bet Blue
                </button>
              </div>
            ...
            <div class="rounded-[14px] border border-white/10 bg-[#0e1730] p-3">
              <div class="flex flex-wrap items-center gap-2 sm:gap-3">
                <div class="mr-1 text-[12px] opacity-80">Amount:</div>

                <button
                  data-amt="100"
                  class="chip h-9 sm:h-10 px-4 sm:px-5 rounded-full bg-green-600/95 hover:bg-green-500 ring-1 ring-green-300/30 text-white font-semibold text-[12px] sm:text-[13px] shadow-[inset_0_1px_0_rgba(255,255,255,.1),0_6px_14px_rgba(0,0,0,.35)]"
                >
                  ₱100
                </button>
                <button
                  data-amt="200"
                  class="chip h-9 sm:h-10 px-4 sm:px-5 rounded-full bg-blue-600/95 hover:bg-blue-500 ring-1 ring-blue-300/30 text-white font-semibold text-[12px] sm:text-[13px] shadow-[inset_0_1px_0_rgba(255,255,255,.1),0_6px_14px_rgba(0,0,0,.35)]"
                >
                  ₱200
                </button>
                <button
                  data-amt="500"
                  class="chip h-9 sm:h-10 px-4 sm:px-5 rounded-full bg-slate-800/95 hover:bg-slate-700 ring-1 ring-slate-300/20 text-white font-semibold text-[12px] sm:text-[13px] shadow-[inset_0_1px_0_rgba(255,255,255,.1),0_6px_14px_rgba(0,0,0,.35)]"
                >
                  ₱500
                </button>
                <button
                  data-amt="1000"
                  class="chip h-9 sm:h-10 px-4 sm:px-5 rounded-full bg-amber-500/95 hover:bg-amber-400 ring-1 ring-amber-200/40 text-black font-semibold text-[12px] sm:text-[13px] shadow-[inset_0_1px_0_rgba(255,255,255,.1),0_6px_14px_rgba(0,0,0,.35)]"
                >
                  ₱1000
                </button>

                <div class="ml-auto flex items-center gap-2 mt-2 sm:mt-0">
                  <div class="text-[12px] opacity-70">Selected:</div>

                  <!-- CUSTOM AMOUNT INPUT (min ₱100) -->
                  <div class="relative">
                    <span
                      class="pointer-events-none absolute left-3 top-1/2 -translate-y-1/2 text-white/80 text-[12px]"
                    >
                      ₱
                    </span>
                    <input
                      ...
                      step="50"
                      value="100"
                      class="w-24 rounded-full border border-white/15 bg-white/10 pl-6 pr-3 py-1.5 text-center text-[12px] font-bold outline-none focus:border-white/40"
                    />
                  </div>
                </div>
              </div>
            ...
            <div class="space-y-3 rounded-[14px] border border-white/10 bg-[#0e1730] p-3">
              <div class="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                <div class="rounded-[12px] border border-white/12 bg-[#0f1a33] p-2">
                  ...
                  <div
                    id="beadWrap"
                    class="overflow-x-auto overflow-y-hidden rounded-[10px] border border-[#263553] p-2"
                  >
                    <div
                      id="beadGrid"
                      class="grid auto-flow-col grid-rows-[repeat(6,16px)] auto-cols-[16px] gap-[6px]"
                    ></div>
                  </div>
                </div>
                <div class="rounded-[12px] border border-white/12 bg-[#0f1a33] p-2">
          ...
          <!-- RIGHT -->
          <aside
            class="flex flex-col rounded-[16px] border border-white/10 bg-[#0c1326e6] p-3 sm:p-4 backdrop-blur-md shadow-[0_10px_30px_rgba(0,0,0,.25),inset_1px_1px_0_rgba(255,255,255,.06)]"
          >
            ...
            <div
              class="flex-1 overflow-auto rounded-[12px] border border-white/12 bg-[#0f1a33] max-h-[260px] sm:max-h-none"
            >
              <table class="w-full text-[12.5px]">
                ...
                <tbody id="histBody" class="[&>tr>td]:px-2 [&>tr>td]:py-1">
                  <tr>
                    <td colspan="5" class="py-3 text-center opacity-70">
                      No bets yet.
                    </td>
                  </tr>
                </tbody>
            ...
            <div class="pt-2 flex items-center justify-between text-[12.5px] gap-2">
              <button
                id="hPrev"
                class="h-8 rounded-[10px] border border-white/15 bg-[#0c1630] px-3 flex-1 sm:flex-none"
              >
                Prev
              </button>
              <div class="font-black text-center">
                Page <span id="hPageNow">1</span> / <span id="hPageTotal">1</span>
              </div>
              <button
                id="hNext"
                class="h-8 rounded-[10px] border border-white/15 bg-[#0c1630] px-3 flex-1 sm:flex-none"
    ...
    <script>
      ...
      amtInput.addEventListener('input',   ()=>{ if(amtInput.value === '') return; if(Number(amtInput.value)<100) amtInput.value = 100; });
