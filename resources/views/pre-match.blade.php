  ...
  <head>
      ...
      <script>
          // Alpine component: pulls from window.TABLE_DATA (if present) or uses sample fallback
          function app() {
              return {
                  sport: 'billiards',
                  ...
                  // Small helpers (kept here for clarity)
                  fmtOdds(odds) {
  ...
  <body
      class="overflow-x-hidden
         bg-[linear-gradient(rgba(0,0,0,.55),rgba(0,0,0,.55)),url('images/loginPicture2.png')]
         bg-cover bg-center bg-no-repeat [min-height:100dvh]"
      x-data="app()">
      <!-- NAV -->
      <nav
      ...
      <div class="overflow-x-hidden bg-gradient-to-b from-slate-950/70 via-slate-800/70 to-slate-700/30 min-h-full">
          <div class="w-full 2xl:max-w-screen-2xl 2xl:mx-auto 2xl:flex 2xl:gap-4">
              ...
              <main class="flex-1">
                  <!-- SPORT CARDS -->
                  <div class="flex space-x-4 my-2 lg:mt-4 lg:-ml-18 lg:scale-80">
                      <!-- Billiards -->
                  ...
                  <div class="flex items-center">
                      <h1 class="font-bold text-xs  text-white lg:text-4xl xl:ml-14">Available Games:</h1>
                      <h1 class="font-semibold text-xs ml-2 text-white lg:text-3xl" x-text="rows().length + ' Games'">
                      </h1>
                  </div>

                  <!-- TABLE CARD -->
                  <div class="flex xl:-ml-3 xl:py-2">
                      <div
                    ...
                    shadow-[inset_0_1px_0_rgba(255,255,255,.05),inset_0_-1px_0_rgba(0,0,0,.35),0_8px_28px_rgba(0,0,0,.45),0_0_0_1px_rgba(51,65,85,.8)]">
                          <table class="w-full table-fixed border-separate border-spacing-0 text-center">
                              ...
                              <colgroup>
                                  ...
                                  <col class="w-[12%]" />
                                  <col class="w-[12%]" />
                                  <!-- wider, responsive last column -->
                                  <col class="w-[140px] md:w-[160px] 2xl:w-[180px]" />
                              </colgroup>

                              <!-- HEAD -->
                              <thead class="text-white sticky top-0 z-10">
                                  <tr
                                      class="bg-gradient-to-b from-slate-900 to-slate-700 relative text-[9px] 2xl:text-[17px] font-semibold">
                                      ...
                                      <th class="px-2 py-1 font-bold tracking-[.02em] border-r border-slate-500/20">
                                          Status</th>
                                      <th class="px-2 py-1 font-bold tracking-[.02em] border-r border-slate-500/20">Odds
                                      </th>
                              ...
                              <!-- BODY (data-driven) -->
                              <tbody class="text-[5px] 2xl:text-[16px]">
                                  <template x-for="row in rows()" :key="row.event + row.venue">
                                      <tr class="transition bg-slate-950/70 even:bg-slate-900/70 hover:bg-slate-800/60">
                                          ...
                                          <td class="px-2 py-3 text-white border-t border-slate-500/20 border-r">
                                              <span
                                                  class="inline-flex items-center gap-1 rounded-full px-1.5 py-0.5 border text-[.75em]
                                    ...
                                    shadow-[0_0_12px_rgba(59,130,246,.18),inset_0_1px_0_rgba(255,255,255,.06)]">
                                                  <i
                                                      class="fa-solid fa-bolt opacity-80 text-[.9em] text-yellow-300"></i>
                                                  <span x-text="row.status" class="text-xs lg:text-sm"></span>
                                              </span>
                                          </td>
                                    ...
                                    shadow-[0_0_12px_rgba(59,130,246,.18),inset_0_1px_0_rgba(255,255,255,.06)]">
                                                  <i
                                                      class="fa-solid fa-coins opacity-80 text-[.9em] text-yellow-300"></i>
                                                  <span x-text="fmtOdds(row.odds)" class="text-xs lg:text-sm"></span>
                                              </span>
                                          </td>

                                          <!-- Action -->
                                          <td class="px-2 py-3 text-white border-t border-slate-500/20">
                                              <a :href="row.href || '#'"
                                                  class="inline-block rounded-full font-bold
                                  bg-gradient-to-b from-yellow-300 to-yellow-600 text-slate-900
                                  border border-yellow-500/70 px-2 py-0.5 text-[.8em] lg:text-[1em]
                                  shadow-[0_2px_10px_rgba(234,179,8,.25),0_0_0_1px_rgba(234,179,8,.35)_inset,0_-2px_0_rgba(0,0,0,.25)_inset]
                                  hover:brightness-105 active:brightness-95 transition">View
                                                  Match</a>
                                          </td>
                                      </tr>
                                  </template>
              ...
              <!-- BETS BLOCK / RIGHT SIDEBAR (visible on all screens; compact on phones) --> @auth <aside
                      class="w-80 xl:scale-90 xl:-ml-28 2xl:w-[26rem] shrink-0 2xl:sticky 2xl:top-4">
                      <div
                          ...
                          <div class="relative px-3 py-3 sm:px-4 sm:py-4">
                              ...
                              <div class="relative flex items-center justify-between gap-2">
                                  ...
                                  <!-- Quick actions -->
                                  <div class="flex items-center gap-1 sm:gap-2"> <button
                              ...
                              <ul class="divide-y divide-slate-800/50"> <!-- Row -->
                                  <li class="px-3 sm:px-4 py-2.5 hover:bg-slate-900/40 transition">
                                      <div class="grid grid-cols-12 items-center gap-2 text-xs sm:text-sm">
                                          ...
                                          <div class="col-span-3 flex justify-center"> <span
                                          ...
                                          <div class="col-span-2 text-right"> <span
                                                  ...
                                                  <i class="fa-regular fa-clock text-[11px]"></i> Pending </span> </div>
                                      </div>
                                  </li> <!-- Row -->
                                  <li class="px-3 sm:px-4 py-2.5 hover:bg-slate-900/40 transition">
                                      <div class="grid grid-cols-12 items-center gap-2 text-xs sm:text-sm">
                                          ...
                                          <div class="col-span-3 flex justify-center"> <span
                                                  ...
                                                  <i class="fa-solid fa-gem text-xs sm:text-sm"></i> ₱1,000 </span> </div>
                                          <div class="col-span-2 text-center"> <span
                                          ...
                                          <div class="col-span-2 text-right"> <span
                                                  ...
                                                  <i class="fa-solid fa-circle-check text-[11px]"></i> Win </span> </div>
                                      </div>
                                  </li> <!-- Row -->
                                  <li class="px-3 sm:px-4 py-2.5 hover:bg-slate-900/40 transition">
                                      <div class="grid grid-cols-12 items-center gap-2 text-xs sm:text-sm">
                                          ...
                                          <div class="col-span-2 text-right"> <span
                                                  ...
                                                  <i class="fa-solid fa-circle-xmark text-[11px]"></i> Lost </span> </div>
                                      </div>
                                  </li> <!-- Add more rows as needed -->
                              </ul>
                          </div> <!-- Footer / summary -->
                          <div class="px-3 sm:px-5 py-2.5 sm:py-3 border-t border-slate-800/60 bg-slate-950/60">
                              <div class="flex items-center justify-between text-[11px] sm:text-[12px]">
                                  <div class="text-slate-300/80"> <span class="mr-2">Open Bets:</span> <span
                                          class="font-bold text-slate-100">3</span> </div>
                                  <div class="flex items-center gap-3">
                                      <div class="text-slate-300/80"> Won: <span class="font-bold text-slate-100">2</span>
                                      </div>
                                      <div class="text-slate-300/80"> Lost: <span
                                              class="font-bold text-slate-100">1</span> </div>
                                  </div>
                              </div>
                          </div>
                      </div>
