...
<x-layouts.app :title="__('Billiard')">
  ...
  <main class="max-w-screen-2xl 2xl:max-w-[1500px] mx-auto p-4">
    <div class="grid gap-4 ml-12
      ...
      <div class="relative z-10 main-panel p-4 rounded-lg shadow-lg mt-3 translate-y-1">
        <!-- Match header -->
        ...
        <!-- LOGROHAN -->
        <div class="bg-gray-900/50 border border-white/10 rounded-lg p-2 logro-zone mt-6.5">
      ...
      <aside>
        <div class="sticky mt-3 space-y-3">

          <!-- ===== Bet Percentage Bar (added, position kept above cards) ===== -->
          <div class="bg-gray-900/60 border border-white/10 rounded-xl p-2 translate-y-1">
          ...
          <!-- Cards -->
          <div id="bet-area" class="bet-area grid grid-cols-2 gap-3 mt-0 mb-0 h-78">
            <!-- Meron -->
